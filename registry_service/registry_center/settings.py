"""
Django settings for registry_center project.
...
SECRET_KEY = 'django-insecure-k*puww^$4xia!wi(5*gkpftgf(3iz0p31#448*ogik+==83(86'
...
ROOT_URLCONF = 'registry_center.urls'
...
WSGI_APPLICATION = 'registry_center.wsgi.application'
